...
const Search: NextPage<Props>  = ({find, setFind} ) => {
  ...
  return (
    ...
    border-2 border-[#333333] p-1.5 px-5 pr-8 flex items-center">
       ...
       <input type="text" 
        ...
        lg:w-full focus:ring-0 outline-none placeholder-[#fafafa]
        text-xs"
        placeholder="Search..."
        />
 
        <div className="flex items-center  divide-dotted 
        divide-x-2 divide-[#333] ml-auto">
           <div className="flex space-x-2 pr-5 ">
            <button className="tag">Minimal</button>
            <button className="tag">Sing</button>
